...
start_automate_Button = tk.Button(window, text="Start", command=Start_Automation)
start_automate_Button.grid(row=5, columnspan=1, padx=10, pady=10)

stop_automate_Button = tk.Button(window, text="Stop", command=Stop_Automation)
stop_automate_Button.grid(row=5, columnspan=2, padx=10, pady=10)
